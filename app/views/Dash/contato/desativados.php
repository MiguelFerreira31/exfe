...
<div class="container my-5">
    <h2 class="text-center fw-bold py-3" style="background:#5e3c2d; color: white; border-radius: 12px;">Contatos Desativados</h2>
            ...
            <tbody>
                <?php foreach ($contatos as $linha): ?>
                    <tr class="fw-semibold">
                        ...
                        <td><?php echo htmlspecialchars($linha['data_contato']); ?></td>
